-- ============================================================================
-- Boleia Angola - Migration V4 (Unificada e Completa)
-- PostgreSQL 17.7 + Supabase
-- Data: 2026-04-13
-- ============================================================================
-- Este script unifica todas as tabelas, tipos, relacionamentos e triggers
-- para o sistema Boleia Angola.
-- ============================================================================
...
-- 5.1 PROFILES
-- Perfis: público pode ler, usuário vê/atualiza o próprio
...
-- Apenas o próprio usuário pode ver suas credenciais
...
-- 5.3 SYSTEM_SETTINGS
-- Settings são públicos para leitura, apenas admin pode alterar
...
-- 5.4 VEHICLES
-- Veículos: todos podem ler, apenas dono pode CUD
...
-- 5.5 RIDES
-- Viagens: todos podem ler, apenas motorista dono pode CUD
...
-- 5.6 BOOKINGS
-- Reservas: passageiro vê as suas, motorista vê das suas viagens
...
-- 5.7 REVIEWS
-- Reviews: participantes podem ver, autores podem CUD
...
-- 5.8 MESSAGES
-- Mensagens: apenas participantes da conversa podem ver/criar
...
-- 5.9 NOTIFICATIONS
-- Notificações: apenas o usuário dono pode ver/criar
...
-- 5.10 WAYPOINTS
-- Waypoints: vinculados a rides, seguem mesmas regras
...
-- 5.11 DOCUMENTS
-- Documentos: apenas o dono pode ver/criar
...
-- 6.1 Trigger para criar profile automaticamente ao criar usuário no auth
...
-- 6.2 Atualizar available_seats quando booking mudar de status
...
-- 6.3 Atualizar updated_at automaticamente
...
-- 6.4 Calcular rating médio do usuário após review
